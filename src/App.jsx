...
<section className="newsletter" id="newsletter"><p className="eyebrow">FREE DOWNLOAD</p><h2>Get The Red Flag File.</h2><p>The 10 contract clauses that quietly cost athletes millions — plus a new legal breakdown every week.</p><form name="get-the-brief" method="POST" data-netlify="true" netlify-honeypot="bot-field" action="/thank-you.html"><input type="hidden" name="form-name" value="get-the-brief"/><p hidden><input name="bot-field"/></p><input type="email" name="email" required placeholder="Email address" aria-label="Email address"/><button type="submit">Send me the file</button></form></section>
